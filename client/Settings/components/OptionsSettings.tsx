  ...
  return (
    <div className="tab-content options">
      ...
      <Toggle fieldName="Rules.RollMonsterHp">
        Roll HP for Names from StatBlock
        <Info>
          When you add a Name from your StatBlock Library, its Hit Point
          Maximum will be generated by rolling the dice expression in the Hit
      ...
      >
        Reroll initiative at the end of each round
      </Dropdown>
