export const tips = [
  ...
  `Monsters and Heroes behave differently when added from the library. A Monster gets cloned, which exists only during the Encounter. On the other hand, Heroes are unique and persists its changes across different Encounters.`,
  `The "Edit Unique Monster" Command lets you make ad-hoc changes to a single Monster without affecting your Monster Library.`,
