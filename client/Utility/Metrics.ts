...
enum MetricEvent {
  AliasSet = "alias_set",
  AllMonstersHidden = "all_monsters_hidden",
  AllMonstersRevealed = "all_monsters_revealed",
  AppLoad = "app_load",
  ...
  CombatantArmorTierChanged = "combatant_armor_tier_changed",
  CombatantDefeated = "combatant_defeated",
  CombatantEnteredLastStand = "combatant_entered_last_stand",
  ...
  CombatantsHiddenInPlayerViewToggled = "combatants_hidden_in_player_view_toggled",
  ...
  Login = "login",
  MonstersGrouped = "monsters_grouped",
  ...
  SafeRestPerformed = "safe_rest_performed",
  ...
  TemporaryHitDiceAdded = "temporary_hit_dice_added",
